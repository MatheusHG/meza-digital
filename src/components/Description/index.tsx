...
const Description: React.FC = () => {
    return(
        <Box>
            <h1 className="title">SHAMPOOS E DERMOCOSMÉTICOS</h1>
            <h2 className="description">Os shampoos dermocosméticos possuem fórmulas especiais que, além de tratar os fios, 
